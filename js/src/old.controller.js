...
var mapController = {
  initMap: function() {
    ...
    landmarks.forEach(function(landmark) {
      var position = landmark.location;
      var title = landmark.title;
...
var ViewModel = function() {
  ...
  //  });
    ...
    self.currentMarker = ko.observable(self.landmarkList()[0]);
  };
  ...
  this.zoomToMarker = function() {
    ...
    console.log("Zoom to Marker", this);
